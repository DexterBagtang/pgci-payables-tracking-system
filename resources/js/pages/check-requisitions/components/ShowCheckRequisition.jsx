                ...
                <div className="space-y-6 print:hidden">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2">
                            <Button onClick={handleCopyDetails} variant="outline" className="w-full justify-start" size="sm">
                                <Copy className="mr-2 h-4 w-4" />
                                Copy Details
                            </Button>
                            <Button onClick={handleShareEmail} variant="outline" className="w-full justify-start" size="sm">
                                <Mail className="mr-2 h-4 w-4" />
                                Share via Email
                            </Button>
                            {invoices && invoices.length > 0 && (
                                <Button onClick={handleExportInvoices} variant="outline" className="w-full justify-start" size="sm">
                                    <FileSpreadsheet className="mr-2 h-4 w-4" />
                                    Export Invoices
                                </Button>
                            )}
                            <Button onClick={handlePrint} variant="outline" className="w-full justify-start" size="sm">

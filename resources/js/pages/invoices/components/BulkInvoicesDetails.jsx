                ...
                <ScrollArea className="h-97 w-full">
                    <div className="p-2 space-y-2">
                        ...
                        <div className="grid grid-cols-4 gap-1.5">
                            ...
                            <div className="bg-slate-50 border border-slate-200 rounded p-1.5">
                                <span
                                    className="text-[9px] font-semibold text-slate-500 uppercase block mb-0.5">Date</span>
                            ...
                            <div className="bg-emerald-50 border border-emerald-200 rounded p-1.5">
                                <span
                                    className="text-[9px] font-semibold text-emerald-600 uppercase block mb-0.5">Amount</span>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="border border-slate-200 rounded bg-white p-2">
                                ...
                                <span
                                    className="flex items-center gap-1 text-[10px] font-semibold text-slate-700 uppercase">
                                    <FileCheck className="h-2.5 w-2.5" />
                                    Attachments
                                </span>
                                    {currentInvoice.files && currentInvoice.files.length > 0 && (
                                        <Badge variant="secondary"
                                               className="bg-blue-50 text-blue-700 text-[9px] h-4 px-1">
                            ...
                            <div className="border border-slate-200 rounded bg-white p-2">
                                <Label htmlFor="notes"
                                       className="text-[10px] font-semibold text-slate-700 uppercase mb-1.5 flex items-center gap-1">

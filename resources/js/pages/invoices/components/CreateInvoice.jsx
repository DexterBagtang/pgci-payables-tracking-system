                                            ...
                                            <Popover>
                                                <PopoverTrigger asChild>
                                                    <Button
                                                        ...
                                                        className={cn(
                                                            "w-full justify-start text-left font-normal mt-1",
                                                            !data.received_date && "text-slate-500"
                                                        )}
                                                    >
                                                        <CalendarIcon className="mr-2 h-4 w-4" />
                                                        {data.received_date ? format(new Date(data.received_date), "PPP") : "Select date"}
                                                    </Button>
                                                </PopoverTrigger>
                                                <PopoverContent className="w-auto p-0" align="start">
                                                    <Calendar
                                                        mode="single"
                                                        selected={data.received_date ? new Date(data.received_date) : undefined}
                                                        onSelect={(date) => handleDateSelect('received_date', date)}
                                                        captionLayout="dropdown"
                                                        className="w-64 mx-auto"
                                                    />
                                                </PopoverContent>
                            ...
                            <div className="border border-emerald-200 rounded-lg p-3 bg-emerald-50">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div>{data.si_date ? format(new Date(data.si_date), "MMM d") : "—"}</div>
                                    </div>
                                    <div>
                                        <div className="text-slate-500">Amount</div>
                            ...
                            <div className="border border-amber-200 rounded-lg p-3 bg-amber-50">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <div>{data.received_date ? format(new Date(data.received_date), "MMM d") : "—"}</div>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div>{data.submitted_at ? format(new Date(data.submitted_at), "MMM d") : "—"}</div>
                                    </div>
                                </div>
                            </div>

...
export default function AddProjectDialog({ trigger }) {
    ...
    const { data, setData, post, processing, errors, setError, reset, clearErrors } = useForm(initialValues);
    ...
    const handleProjectTypeChange = (value) => {
        setData(prevData => ({
            ...prevData,
            project_type: value,
            smpo_number: '', // Reset when changing project type
            philcom_category: '' // Reset when changing project type
        }));
        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-[600px] overflow-y-auto">
                <SheetHeader>
                    ...
                    <SheetDescription>
                        Provide all the details of the new project.
                    </SheetDescription>
                </SheetHeader>

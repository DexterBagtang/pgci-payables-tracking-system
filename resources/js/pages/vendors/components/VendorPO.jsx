            ...
            <CardContent>
                {purchase_orders.length === 0 ? (
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No Purchase Orders</h3>
                        <p className="text-gray-500 dark:text-gray-400 mb-6">This vendor doesn't have any purchase orders yet.</p>
                    </div>
                ) : (
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {purchase_orders.map((po) => (
                            <Card key={po.id} className="shadow-sm border dark:border-gray-700">
                                ...
                                <CardContent className="space-y-2 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-gray-600 dark:text-gray-400">{formatDate(po.po_date,'PP')}</span>
                                    </div>
